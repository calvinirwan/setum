...
}catch (e5595){if((e5595 instanceof Object))
{var e = e5595;return null;
} else
{throw e5595;
...
{var name_str = cljs.core.name(dashed);var vec__5597 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str,/-/);var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5597,(0),null);var parts = cljs.core.nthnext(vec__5597,(1));if(cljs.core.truth_((reagent.impl.util.dont_camel_case.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.util.dont_camel_case.cljs$core$IFn$_invoke$arity$1(start) : reagent.impl.util.dont_camel_case.call(null,start))))
{return name_str;
} else
...
reagent.impl.util.partial_ifn.cljs$lang$ctorPrWriter = (function (this__4125__auto__,writer__4126__auto__,opt__4127__auto__){return cljs.core._write(writer__4126__auto__,"reagent.impl.util/partial-ifn");
});
...
var G__5599__delegate = function (self__,a){var self____$1 = this;var _ = self____$1;var or__3558__auto___5600 = self__.p;if(cljs.core.truth_(or__3558__auto___5600))
{} else
{self__.p = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.partial,self__.f,self__.args);
}
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(self__.p,a);
};
var G__5599 = function (self__,var_args){
var self__ = this;
var a = null;if (arguments.length > 1) {
  a = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__5599__delegate.call(this,self__,a);};
G__5599.cljs$lang$maxFixedArity = 1;
G__5599.cljs$lang$applyTo = (function (arglist__5601){
var self__ = cljs.core.first(arglist__5601);
var a = cljs.core.rest(arglist__5601);
return G__5599__delegate(self__,a);
});
G__5599.cljs$core$IFn$_invoke$arity$variadic = G__5599__delegate;
return G__5599;
})()
;
reagent.impl.util.partial_ifn.prototype.apply = (function (self__,args5598){var self__ = this;
var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args5598)));
});
reagent.impl.util.partial_ifn.prototype.cljs$core$IFn$_invoke$arity$2 = (function() { 
var G__5602__delegate = function (a){var _ = this;var or__3558__auto___5603 = self__.p;if(cljs.core.truth_(or__3558__auto___5603))
{} else
{self__.p = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.partial,self__.f,self__.args);
}
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(self__.p,a);
...
return G__5602__delegate.call(this,a);};
G__5602.cljs$lang$maxFixedArity = 0;
G__5602.cljs$lang$applyTo = (function (arglist__5604){
var a = cljs.core.seq(arglist__5604);
return G__5602__delegate(a);
});
...
reagent.impl.util.clj_ifn_QMARK_ = (function clj_ifn_QMARK_(x){var or__3558__auto__ = cljs.core.ifn_QMARK_(x);if(or__3558__auto__)
{return or__3558__auto__;
} else
{var G__5608 = x;if(G__5608)
{var bit__4208__auto__ = (G__5608.cljs$lang$protocol_mask$partition1$ & (256));if((bit__4208__auto__) || (G__5608.cljs$core$IMultiFn$))
{return true;
} else
{if((!G__5608.cljs$lang$protocol_mask$partition1$))
{return cljs.core.native_satisfies_QMARK_(cljs.core.IMultiFn,G__5608);
} else
{return false;
}
}
...
reagent.impl.util._not_found = (function (){var obj5610 = {};return obj5610;
})();
...
reagent.impl.util.shallow_equal_maps = (function shallow_equal_maps(x,y){var or__3558__auto__ = (x === y);if(or__3558__auto__)
{return or__3558__auto__;
} else
{var and__3546__auto__ = cljs.core.map_QMARK_(x);if(and__3546__auto__)
{var and__3546__auto____$1 = cljs.core.map_QMARK_(y);if(and__3546__auto____$1)
{var and__3546__auto____$2 = (cljs.core.count(x) === cljs.core.count(y));if(and__3546__auto____$2)
{return cljs.core.reduce_kv(((function (and__3546__auto____$2,and__3546__auto____$1,and__3546__auto__,or__3558__auto__){
return (function (res,k,v){var yv = cljs.core.get.cljs$core$IFn$_invoke$arity$3(y,k,reagent.impl.util._not_found);if(cljs.core.truth_((function (){var or__3558__auto____$1 = (v === yv);if(or__3558__auto____$1)
{return or__3558__auto____$1;
} else
{var or__3558__auto____$2 = reagent.impl.util.identical_ish_QMARK_(v,yv);if(or__3558__auto____$2)
{return or__3558__auto____$2;
} else
{var and__3546__auto____$3 = cljs.core.keyword_identical_QMARK_(k,cljs.core.constant$keyword$46);if(and__3546__auto____$3)
...
});})(and__3546__auto____$2,and__3546__auto____$1,and__3546__auto__,or__3558__auto__))
,true,x);
} else
...
var or__3558__auto__ = (v1 === v2);if(or__3558__auto__)
{return or__3558__auto__;
} else
{var and__3546__auto__ = (cljs.core.count(v1) === cljs.core.count(v2));if(and__3546__auto__)
{return cljs.core.reduce_kv(((function (and__3546__auto__,or__3558__auto__){
return (function (res,k,v){var v_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(v2,k);if(cljs.core.truth_((function (){var or__3558__auto____$1 = (v === v_SINGLEQUOTE_);if(or__3558__auto____$1)
{return or__3558__auto____$1;
} else
{var or__3558__auto____$2 = reagent.impl.util.identical_ish_QMARK_(v,v_SINGLEQUOTE_);if(or__3558__auto____$2)
{return or__3558__auto____$2;
} else
{var and__3546__auto____$1 = cljs.core.map_QMARK_(v);if(and__3546__auto____$1)
...
});})(and__3546__auto__,or__3558__auto__))
,true,v1);
} else
{return and__3546__auto__;
}
