...
reagent.impl.component.do_render = (function do_render(C){var _STAR_current_component_STAR_5454 = reagent.impl.component._STAR_current_component_STAR_;try{reagent.impl.component._STAR_current_component_STAR_ = C;
var f = (C[reagent.impl.component.cljs_render]);var _ = ((reagent.impl.util.clj_ifn_QMARK_(f))?null:(function(){throw (new Error(("Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.list(new cljs.core.Symbol("util","clj-ifn?","util/clj-ifn?",259370460,null),new cljs.core.Symbol(null,"f","f",43394975,null))], 0))))))})());var p = reagent.impl.util.js_props(C);var res = ((((C["componentFunction"]) == null))?(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(C) : f.call(null,C)):(function (){var argv = (p[reagent.impl.util.cljs_argv]);var n = cljs.core.count(argv);var G__5455 = n;switch (G__5455) {
case (1):
...
reagent.impl.component.custom_wrapper = (function custom_wrapper(key,f){var G__5458 = (((key instanceof cljs.core.Keyword))?key.fqn:null);switch (G__5458) {
case "componentWillUnmount":
return ((function (G__5458){
...
{return (function() { 
var G__5460__delegate = function (args){var C = this;return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,C,args);
};
...
{var G__5463 = f;(G__5463["__reactDontBind"] = true);
return G__5463;
} else
{return f;
}
...
{var wrap = reagent.impl.component.custom_wrapper(key,f);if(cljs.core.truth_((function (){var and__3546__auto__ = wrap;if(cljs.core.truth_(and__3546__auto__))
{return f;
} else
...
{}
var or__3558__auto__ = wrap;if(cljs.core.truth_(or__3558__auto__))
...
reagent.impl.component.map_to_js = (function map_to_js(m){return cljs.core.reduce_kv((function (o,k,v){var G__5465 = o;(G__5465[cljs.core.name(k)] = v);
return G__5465;
}),{},m);
});
...
return (function() { 
var G__5466__delegate = function (args){return (as_component.cljs$core$IFn$_invoke$arity$1 ? as_component.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args)) : as_component.call(null,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args)));
};
