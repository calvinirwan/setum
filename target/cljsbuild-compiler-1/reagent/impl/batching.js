...
reagent.impl.batching.next_tick = ((cljs.core.not(reagent.impl.util.is_client))?reagent.impl.batching.fake_raf:(function (){var w = window;var or__3558__auto__ = w.requestAnimationFrame;if(cljs.core.truth_(or__3558__auto__))
{return or__3558__auto__;
} else
{var or__3558__auto____$1 = w.webkitRequestAnimationFrame;if(cljs.core.truth_(or__3558__auto____$1))
{return or__3558__auto____$1;
} else
{var or__3558__auto____$2 = w.mozRequestAnimationFrame;if(cljs.core.truth_(or__3558__auto____$2))
{return or__3558__auto____$2;
} else
{var or__3558__auto____$3 = w.msRequestAnimationFrame;if(cljs.core.truth_(or__3558__auto____$3))
...
var n__4414__auto__ = a.length;var i = (0);while(true){
if((i < n__4414__auto__))
{var C_5468 = (a[i]);if(cljs.core.truth_(C_5468.cljsIsDirty))
{C_5468.forceUpdate();
} else
{}
{
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__4125__auto__,writer__4126__auto__,opt__4127__auto__){return cljs.core._write(writer__4126__auto__,"reagent.impl.batching/RenderQueue");
});
...
reagent.impl.batching.is_reagent_component = (function is_reagent_component(C){var and__3546__auto__ = !((C == null));if(and__3546__auto__)
{var and__3546__auto____$1 = (C["props"]);if(cljs.core.truth_(and__3546__auto____$1))
...
reagent.impl.batching.dispose = (function dispose(C){var ratom_5470 = C.cljsRatom;if(!((ratom_5470 == null)))
{reagent.ratom.dispose_BANG_(ratom_5470);
} else
{}
